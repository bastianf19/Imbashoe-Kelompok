                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src='<?= $this->url->get($prod->produk->foto_produk) ?>' class="mx-auto d-block" width="100"
                                            height="100"></td>
                                    ...
                                    <td><a href="<?= $this->url->get('produk/hapuswish/' . $prod->id_wishlist) ?>"
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col text-center">
                                    <a href="<?= $this->url->get('/') ?>" class="btn  btn-outline-primary"
