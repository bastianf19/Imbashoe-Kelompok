						...
						<div class="right-bar">
							...
							<div class="sinlge-bar shopping">
								...
								<div class="shopping-item">
									<div class="dropdown-cart-header">
										<span>2 Items</span>
										<a href="<?= $this->url->get('produk/listwish/') ?>">View Wishlist</a>
									</div>
									<ul class="shopping-list">
										<?php foreach ($cari as $prod) { ?>
										<li>
											<a class="cart-img" href="#"><img src='<?= $this->url->get($prod->produk->foto_produk) ?>' class="mx-auto d-block" width="100"
												height="100"></a>
											<h4><a href="#"><?= $prod->produk->nama_produk ?></a></h4>
											<span><?= $prod->produk->harga_produk ?></span>
											<a href="<?= $this->url->get('produk/hapuswish/' . $prod->id_wishlist) ?>" class="btn btn-sm btn-outline-danger"></i>Hapus</a>
										</li>
										<?php } ?>
										<!-- <li>
									...
									<div class="bottom">
										<a href="<?= $this->url->get('produk/listwish/') ?>" class="btn animate">Lihat Selengkapnya</a>
									</div>
								</div>
								<!--/ End Shopping Item -->
							</div>
												...
												<div class="product-img">
													...
													<div class="button-head">
														<div class="product-action">
															...
															<!-- <a title="Wishlist" href="<?= $this->url->get('produk/tambahwish/' . $produk->id_produk) ?>"><i class="fa fa-heart" aria-hidden="true"></i><span>Add to Wishlist</span></a> -->
