							...
							<div class="sinlge-bar signin">
								...
								<div class="signin-popup">
									<div class="dropdown-cart-header">
										...
										<div class="sign-form">
											<div>
												<a>Halo <strong><?php if ($sess == 1) { ?> <?= $this->session->get('auth')['nama'] ?> <?php } ?> </strong>, selamat datang di <strong>Imbashoe</strong></a>
												
											</div>
											<div>
												<a href="<?php if ($sess == 1) { ?> <?= $this->url->get('/signup/edit/' . $this->session->get('auth')['id_user']) ?> <?php } ?>">Edit Profile</a>
											</div>
											<div>
												<a href="<?php if ($sess == 1) { ?> <?= $this->url->get('Session/logout') ?> <?php } ?>">Logout</a>
											</div>
										</div>
									</div>
		...
		<div class="row mt-20">
			...
			<div class="col-md-7">
				<div class="single-product-details">
					...
					<br>
					<br>
					<a href="<?= $this->url->get('produk/tambahwish/' . $produk->id_produk) ?>" class=" btn btn-lg btn-danger" role="button"><i class="fa fa-heart" aria-hidden="true"></i> Tambahkan ke Wishlist</a>
					<!-- <button class=" btn btn-lg btn-primary"><a href=Tambahkan ke Wishlist</button> -->
					<a href="<?= $this->url->get('produk/listwish/') ?>" class=" btn btn-lg btn-primary" role="button">Daftar Wishlist</a>
				</div>
			</div>
