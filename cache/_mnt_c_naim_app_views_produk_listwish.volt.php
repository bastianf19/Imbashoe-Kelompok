                ...
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h3 class="card-title text-center"><a href=""><img src="/img/Logoimba.png"
                                    style="max-height: 300px; max-width: 300px;"></a><br>Wishlist Produk | Quantity:
                            <?php echo $cari->count(); ?>
                        </h3>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?= $this->url->get('produk/hapuswish/' . $prod->id_wishlist) ?>"
                                            class='btn btn-outline-primary btn-block'>Hapus</a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        <div class="container">
                            <div class="row">
                                <div class="col text-center">
                                    ...
                                    <a href="<?= $this->url->get('/produk') ?>" class="btn btn-lg btn-outline-primary"
