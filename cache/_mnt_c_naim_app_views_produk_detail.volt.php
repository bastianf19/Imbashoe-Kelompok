		...
		<div class="row mt-20">
			...
			<div class="col-md-7">
				<div class="single-product-details">
					...
					<br>
					<br>
					<a href="<?= $this->url->get('produk/tambahwish/' . $produk->id_produk) ?>" class=" btn btn-lg btn-primary" role="button">Tambahkan ke Wishlist</a>
					<!-- <button class=" btn btn-lg btn-primary"><a href=Tambahkan ke Wishlist</button> -->
					<a href="<?= $this->url->get('produk/listwish/') ?>" class=" btn btn-lg btn-primary" role="button">test</a>
				</div>
			</div>
