                ...
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h3 class="card-title text-center"><a href=""><img src="/public/img/logo.png"
                                    style="max-height: 300px; max-width: 300px;"></a><br>Cari Produk | '<?php echo $nama_user; ?>'
                        </h3>
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    <a href="<?= $this->url->get('/admin') ?>" class="btn btn-lg btn-outline-primary"
                                        role="button">Menu</a>
                                    <a href="<?= $this->url->get('/signup/list') ?>" class="btn btn-lg btn-outline-primary"
                                        role="button">List Users</a>
                                </div>
                            </div>
                        </div>
                    </div>
