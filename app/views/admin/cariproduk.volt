      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('/admin/edit/' ~ session.get('auth')['id_user']) }}"">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex table-responsive">
                    <div class="btn-group mr-2">
                      <a href="{{url('/signup')}}"><button class="btn btn-danger"><i class="fas fa-plus"></i> Add</button></a>
                    </div>
                    ...
                    <table class="table mt-3 border-top">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ url('admin/edituser/' ~ user.id_user) }}" class='btn btn-primary btn-block'>Edit</a><br>
